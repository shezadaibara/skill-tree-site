...
Given a company, what should you learn to get hired there? This site reads the
open job postings of 49 employers — mostly German, mostly technology and
industry — works out what each role demands, and draws the result as a graph and
a matrix you can read.
...
Pull requests against it will be overwritten by the next build.
